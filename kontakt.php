<html>
    ...
    <body>
        <div class="top_bar">  
            <a href="index.php"><div class="menu" href="#">O Nas</div></a>
        ...
        <div class="hello" style="font-size:40px;">Formularz </div>
        <div style="width:100%;text-align:center;">
            <form action="call_post.php" method="POST"  style="position:absolute;left:50%;transform: translate(-50%, 0);">
                <input name="tresc" placeholder="Treść" style="width:400px;height:200px;"><br>
                <input name="tel" placeholder="Telefon" style="margin-top:10px;"><br>
