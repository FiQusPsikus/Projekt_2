<html>
    ...
    <body>
        ...
        <div style="width:100%;text-align:center;font-size:40px;">Dziękujemy za kontakt !</div>
        <div style="width:100%;text-align:center;font-size:30px;">Postaramy się z Tobą skontaktować najszybciej jak to będzie możliwe.
